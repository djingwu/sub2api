...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	saturationService := service.NewSaturationService(usageLogRepository, settingRepository)
	saturationHandler := handler.NewSaturationHandler(saturationService)
	...
	channelService := service.NewChannelService(channelRepository, groupRepository, apiKeyAuthCacheInvalidator, pricingService, channelCachePubSub, accountRepository)
	...
	managerScopeHandler := admin.NewManagerScopeHandler(adminService, managerService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, managerScopeHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	modelPlazaService := service.NewModelPlazaService(channelRepository, groupRepository, accountRepository, pricingService, billingService, modelPricingResolver)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, managerOnlyMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, redisClient)
	...
	subscriptionAutoRenewService := service.ProvideSubscriptionAutoRenewService(userSubscriptionRepository, userRepository, subscriptionService, leaderLockCache, db)
