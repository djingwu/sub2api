...
// trailing args are: session_id, native_compaction_v2, created_at, raw_actual_cost,
// raw_total_cost. session_id is therefore the fifth-from-last arg.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 64, "arg-type table must include session_id, native_compaction_v2 and the two raw audit columns")
	...
	// session_id is the fifth-from-last arg (native_compaction_v2, created_at, raw_actual_cost, raw_total_cost follow it).
