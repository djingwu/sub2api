...
// trailing args are: account_stats_cost, session_id, created_at, raw_actual_cost,
// raw_total_cost. session_id is therefore the fourth-from-last arg.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 61, "arg-type table must include session_id and the two raw audit columns")
	...
	// session_id is the fourth-from-last arg (created_at, raw_actual_cost, raw_total_cost follow it).
