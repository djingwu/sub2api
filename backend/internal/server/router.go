...
func SetupRouter(
	...
	managerOnly middleware2.ManagerOnlyMiddleware,
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, managerOnly, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterManagerRoutes(v1, h, jwtAuth, managerOnly, panelRateLimiter)
