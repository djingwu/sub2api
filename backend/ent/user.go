...
type User struct {
	...
	// PrimaryDeptID holds the value of the "primary_dept_id" field.
...
type UserEdges struct {
	...
	// WhiteListedAccounts holds the value of the white_listed_accounts edge.
	WhiteListedAccounts []*Account `json:"white_listed_accounts,omitempty"`
...
// WhiteListedAccountsOrErr returns the WhiteListedAccounts value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) WhiteListedAccountsOrErr() ([]*Account, error) {
	if e.loadedTypes[6] {
		return e.WhiteListedAccounts, nil
	}
	return nil, &NotLoadedError{edge: "white_listed_accounts"}
}
...
// was not loaded in eager-loading.
func (e UserEdges) AccountAllowedUsersOrErr() ([]*AccountAllowedUser, error) {
	if e.loadedTypes[15] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldPrimaryDeptID, user.FieldConcurrency, user.FieldRpmLimit:
	...
	for i := range columns {
		...
		case user.FieldPrimaryDeptID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field primary_dept_id", values[i])
			} else if value.Valid {
				_m.PrimaryDeptID = new(int64)
				*_m.PrimaryDeptID = value.Int64
			}
...
// QueryWhiteListedAccounts queries the "white_listed_accounts" edge of the User entity.
func (_m *User) QueryWhiteListedAccounts() *AccountQuery {
	return NewUserClient(_m.config).QueryWhiteListedAccounts(_m)
}
...
// QueryAccountAllowedUsers queries the "account_allowed_users" edge of the User entity.
func (_m *User) QueryAccountAllowedUsers() *AccountAllowedUserQuery {
	return NewUserClient(_m.config).QueryAccountAllowedUsers(_m)
}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	if v := _m.PrimaryDeptID; v != nil {
		builder.WriteString("primary_dept_id=")
