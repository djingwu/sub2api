...
export interface User {
  ...
  role: 'admin' | 'manager' | 'user' // User role for authorization
...
export interface SubscriptionProgress {
  ...
  expires_at: string
  expires_in_days: number
  daily?: SubscriptionProgressWindow
  weekly?: SubscriptionProgressWindow
  monthly?: SubscriptionProgressWindow
}
