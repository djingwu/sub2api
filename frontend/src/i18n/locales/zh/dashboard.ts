export default {
  ...
  departmentUsage: {
    ...
    reasoningDescription: '所选范围内 GPT 系模型按思考档位（reasoning effort）的请求占比，可查看全部部门或单个部门。',
    reasoningScopeLabel: '部门范围',
    reasoningGroupAll: '全部部门',
    reasoningSourceEffective: '实际生效',
    reasoningSourceRequested: '客户端请求',
    reasoningRequestedNotice: '客户端很少显式指定思考档位，该口径下多数请求会记为“未指定”。',
    reasoningModelScopeGpt: '仅 GPT 系',
    reasoningModelScopeAll: '全部模型',
    reasoningModelFamily: '按模型族归类',
    ...
    rankingDescription: '按总 Token 用量排名的部门（名称已匿名化）。',
    anonymousDepartment: '部门 {code}',
    rankingHidden: '另有 {count} 个部门未展示',
    modelDistributionTitle: '模型分布',
    modelDistributionDescription: '全团队最常用模型的 Token 占比。',
    modelDistributionEmpty: '所选时间范围内暂无模型数据',
    modelDistributionLoadFailed: '加载模型分布失败',
    clientSoftwareTitle: '客户端软件统计',
    clientSoftwareDescription: '全团队的客户端软件统计，由请求 User-Agent 规范化得出。',
    ...
    unusedDepartmentsHint: '所选范围内没有请求的活跃非专属分组。',
