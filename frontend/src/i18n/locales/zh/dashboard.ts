export default {
  ...
  departmentUsage: {
    ...
    noModelData: '暂无模型数据',
    reportTitle: '统计报表',
    reportDescription: '全部门合计的 Token 趋势，以及各模型的使用趋势。',
    reportTotalTitle: '全部门合计趋势',
    reportModelsTitle: '各模型趋势',
    granularityLabel: '统计粒度',
    granularityDay: '按日',
    granularityWeek: '按周',
    granularityMonth: '按月',
    reportEmpty: '所选时间范围内暂无趋势数据',
    reportLoadFailed: '加载趋势报表失败',
    requests: '请求数',
    otherModels: '其他模型',
    cacheHitRate: '缓存命中率',
    modelCount: '模型数',
