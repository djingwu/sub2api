export default {
  ...
  departmentUsage: {
    badge: '团队透明度',
    title: '部门 Token 用量',
    description: '查看各部门在所选时间范围内的 Token 汇总。此页面不显示费用、用户或请求明细。',
    otherTitle: '其他分组 Token 用量',
    otherDescription: '查看非部门分组（如免费组、cline）及未分组用量在所选时间范围内的 Token 汇总。此页面不显示费用、用户或请求明细。',
    timeRange: '时间范围',
    scopeDepartment: '部门',
    scopeOther: '其他分组',
    tableTitle: '部门用量汇总',
    tableTitleOther: '其他分组用量汇总',
    tokenOnlyNote: '仅展示 Token 数量',
    department: '部门',
    group: '分组',
    tokens: 'Token 数量',
    unassigned: '未分组',
    noData: '暂无部门用量',
    noDataHint: '调整时间范围后重试。',
    loadFailed: '加载部门用量失败',
    sortLabel: '排序',
    sortByName: '按部门名称',
    sortByTokens: '按 Token 数量',
    sortAsc: '升序',
    sortDesc: '降序',
    topModels: 'Top 5 模型',
    expandTopModels: '展开模型明细',
    collapseTopModels: '收起模型明细',
    noModelData: '暂无模型数据',
    reportLoadFailed: '加载报表失败',
    requests: '请求数',
    cacheHitRate: '缓存命中率',
    modelCount: '模型数',
    activeUsers: '活跃用户',
    ...
    videos: '视频',
    concentration: '模型集中度',
    topOneShare: 'Top 1 占比',
    topNShare: 'Top {n} 占比',
    vsPrevPeriod: '环比',
    noBaseline: '无对比数据',
    sortByRequests: '按请求数',
    sortByPerCapita: '按人均 Token',
    sortByLatency: '按平均时延',
    heatmapTitle: '活跃时段分布',
    heatmapDescription: '所选范围内按星期与小时的请求分布。',
    heatmapEmpty: '所选时间范围内暂无时段数据',
    heatmapCell: '{requests} 请求 · {tokens} Token',
    weekdayMon: '周一',
    weekdayTue: '周二',
    weekdayWed: '周三',
    weekdayThu: '周四',
    ...
    weekdaySat: '周六',
    weekdaySun: '周日',
    reasoningTitle: 'GPT 思考模式占比',
    reasoningDescription: '所选范围内 GPT 系模型按实际生效思考档位（reasoning effort）的请求占比，先选具体模型，再看各部门分布。',
    reasoningDescriptionOther: '所选范围内 GPT 系模型按实际生效思考档位（reasoning effort）的请求占比，先选具体模型，再看各分组分布。',
    reasoningScopeLabel: '部门范围',
    reasoningScopeLabelOther: '分组范围',
    reasoningGroupAll: '全部部门',
    reasoningGroupAllOther: '全部分组',
    reasoningModelLabel: 'GPT 模型',
    reasoningModelAll: '全部 GPT 模型',
    reasoningDepartmentsTitle: '按部门占比',
    reasoningDepartmentsTitleOther: '按分组占比',
    reasoningDepartmentsTitleForModel: '{model} · 按部门占比',
    reasoningDepartmentsTitleForModelOther: '{model} · 按分组占比',
    reasoningDepartmentsDescription: '所选模型范围内各部门的思考档位分布。',
    reasoningDepartmentsDescriptionOther: '所选模型范围内各分组的思考档位分布。',
    reasoningDepartmentsDescriptionForModel: '{model} 在各部门的思考档位分布。',
    reasoningDepartmentsDescriptionForModelOther: '{model} 在各分组的思考档位分布。',
    ...
    expandReasoning: '展开报表',
    collapseReasoning: '收起报表',
    effortHigh: 'High',
    effortMedium: 'Medium',
    effortLow: 'Low',
    ...
    effortMax: 'Max',
    effortNone: 'None',
    kpiTotalRequests: '总请求数',
    kpiTotalTokens: '总 Token',
    kpiActiveDepartments: '活跃部门',
    kpiActiveGroups: '活跃分组',
    kpiActiveUsers: '活跃用户',
    rankingTitle: 'Token 用量排行',
    rankingDescription: '按总 Token 用量排名的部门。',
    rankingDescriptionOther: '按总 Token 用量排名的非部门分组。',
    rankingHidden: '另有 {count} 个部门未展示',
    modelDistributionTitle: '模型分布',
    modelDistributionDescription: '所选范围内最常用模型的 Token 占比。',
    modelDistributionEmpty: '所选时间范围内暂无模型数据',
    modelDistributionLoadFailed: '加载模型分布失败',
    clientSoftwareTitle: '客户端软件统计',
    clientSoftwareDescription: '所选范围的客户端软件统计，由请求 User-Agent 规范化得出。',
    clientSoftware: '客户端软件',
    departmentsUsing: '使用部门数',
    groupsUsing: '使用分组数',
    clientSoftwareEmpty: '所选时间范围内暂无客户端软件数据',
    clientSoftwareLoadFailed: '加载客户端软件统计失败',
    coverageHint: '覆盖率 {percent}%',
    unusedDepartmentsTitle: '未使用部门（{count}）',
    unusedDepartmentsHint: '所选范围内没有请求的活跃部门分组。',
    rankUp: '较上期上升 {count} 位',
    rankDown: '较上期下降 {count} 位',
    rankSame: '较上期排名不变',
    shareOfTeam: '占团队 Token 的 {percent}%',
    shareOfScope: '占所选范围 Token 的 {percent}%',
    intensityVsTeam: '为团队均值的 {ratio} 倍',
    intensityVsScope: '为所选范围均值的 {ratio} 倍',
    teamAverageCacheRate: '团队均值 {value}',
    scopeAverageCacheRate: '所选范围均值 {value}',
    flagCacheLow: '缓存命中率明显低于团队均值',
    flagCacheLowScope: '缓存命中率明显低于所选范围均值',
    flagHeavyContext: '单请求上下文较大',
    flagSlowFirstToken: '首 Token 偏慢',
    peakPeriod: '峰值时段 {label} · {requests} 请求',
    offHoursShare: '非工作时段请求占比 {percent}%',
    allDepartments: '全部部门',
    allGroups: '全部分组',
    otherGroupsHint: '非部门分组另有 {count} 个 · {requests} 请求 · {tokens} Token',
    viewOtherGroups: '查看其他分组',
    insightsTitle: '智能洞察',
    insightsDescription: '基于所选范围自动生成的数据结论。',
    insightsEmpty: '所选时间范围内暂无可生成的洞察',
    insightCoverage: '{total} 个部门中 {used} 个有使用（覆盖率 {rate}），{unused} 个未使用',
    insightCoverageFull: '本期全部 {total} 个部门均有使用',
    insightGrowth: '{name} 环比增长 {percent}（{tokens} Token）',
    insightDecline: '{name} 环比下降 {percent}（{tokens} Token）',
    insightIntensity: '{name} 人均 {perCapita} Token，为团队均值的 {ratio} 倍',
    insightCacheLow: '{name} 的 Prompt 缓存命中率仅 {rate}（团队均值 {average}），涉及 {input} 输入 Token，建议优化提示缓存',
    insightConcentration: '{name} 有 {share} 的 Token 集中在 {model}',
    insightClientTop: '{client} 是主要客户端，占团队 Token 的 {share}，覆盖 {departments} 个部门',
  ...
  saturation: {
    ...
    config: {
      edit: '配置基准组合',
      title: '基准组合配置',
      description: '基准组合代表性价比最优的用法。费用占比达到阈值的用户视为达标；累计用量始终包含历史窗口，刷新归零不会影响判断。',
      combos: '基准组合',
      addCombo: '添加组合',
      modelPlaceholder: '模型名称，如 gpt-5.6-luna',
      threshold: '达标阈值（%）',
      thresholdHint: '基准组合费用占本期已用费用的比例达到该值即视为达标',
      invalid: '请至少配置一个基准组合，阈值需在 0-100 之间',
      saveFailed: '保存失败'
    },
    kpi: {
      users: '配额用户',
      usersHint: '拥有有效订阅且额度大于 0 的用户',
      avgSaturation: '本期平均饱和度',
      avgSaturationHint: '累计平均 {value}',
      used: '本期已用 / 额度',
      lifetimeUsed: '累计已用',
      lifetimeUsedHint: '自首次使用以来的订阅计费用量',
      dormant: '沉睡用户（<20%）',
      dormantHint: '本期用量低于额度的 20%',
      heavy: '重度用户（≥80%）',
      heavyHint: '本期用量达到额度的 80% 以上',
      reset: '刷新 / 重置用户',
      resetHint: '本期已归零但累计有用量',
      compliant: '基准组合达标',
      compliantHint: '达标率 {rate}（按本期有用量的用户计算）'
    },
    distribution: {
      title: '饱和度分布',
      subtitle: '按额度使用比例分组，可切换本期与累计口径',
      current: '本期',
      lifetime: '累计',
      dormant: '<20% 沉睡',
      light: '20-50% 轻度',
    ...
    baseline: {
      title: '基准组合达标',
      description: '费用占比指基准组合在本期已用费用中的份额；Token 占比按 Token 计算。',
      costShare: '费用占比（本期）',
      tokenShare: 'Token 占比（本期）',
      threshold: '达标线 {value}%',
      met: '{count} 人达标 / {total} 人有使用',
      hint: '达标人数按本期有用量且基准费用占比达到阈值的用户计算'
    },
    trend: {
      title: '每日用量趋势',
      subtitle: '按订阅计费用量逐日统计（取自用量日志，窗口刷新不影响）',
      tokens: 'Token',
      cost: '费用',
      last7Days: '近 7 天',
      last14Days: '近 14 天',
      last30Days: '近 30 天',
      last90Days: '近 90 天',
      totalTokens: '期间 Token {value}',
      totalCost: '期间费用 {value}',
      dailyAverage: '日均 {value}',
      peakDay: '峰值 {date} {value}',
      tooltipTokens: 'Token {value}',
      tooltipCost: '费用 {value}',
      tooltipRequests: '请求 {value}'
    },
    combos: {
      title: '模型组合用量与性价比',
      description: '本期各「模型 + 推理强度」组合的用量与单位成本；标注“基准”的为配置中的性价比组合。',
      model: '模型',
      effort: '推理强度',
      requests: '请求',
      tokens: 'Token',
    ...
    users: {
      title: '用户明细',
      subtitle: '点击表头排序，可按饱和度区间与达标情况筛选',
      searchPlaceholder: '搜索用户 / 部门 / 分组',
      allBands: '全部饱和度',
      allCompliance: '全部达标情况',
      compliant: '已达标',
      nonCompliant: '未达标',
      user: '用户',
      dept: '部门',
      ...
      lifetime: '累计已用',
      cycles: '{count} 个周期',
      baselineShare: '基准费用占比',
      topCombo: '主要组合',
      requests: '请求数',
      windowRequests: '本期 {count}',
      lastUsed: '最后活跃',
      empty: '暂无数据'
    }
  },
