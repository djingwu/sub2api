export default {
  ...
  departmentUsage: {
    ...
    reportDescription: 'Token trend across all departments plus a per-model breakdown.',
    reportTotalTitle: 'All Departments Trend',
    reportModelsTitle: 'Model Trend',
    granularityLabel: 'Granularity',
    granularityDay: 'Daily',
    granularityWeek: 'Weekly',
    granularityMonth: 'Monthly',
    reportEmpty: 'No trend data in the selected range',
