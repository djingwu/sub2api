export default {
  ...
  departmentUsage: {
    ...
    reasoningDescription: 'Request share of each reasoning-effort tier for GPT-family models in the selected range, for all departments or a single department.',
    reasoningScopeLabel: 'Department',
    reasoningGroupAll: 'All departments',
    reasoningSourceEffective: 'Effective',
    reasoningSourceRequested: 'Requested',
    reasoningRequestedNotice: 'Clients rarely send an explicit effort, so most requests show up as unspecified under this view.',
    reasoningModelScopeGpt: 'GPT only',
    reasoningModelScopeAll: 'All models',
    reasoningModelFamily: 'Group by model family',
    ...
    rankingDescription: 'Top departments by total token usage (names anonymized).',
    anonymousDepartment: 'Department {code}',
    rankingHidden: '{count} more departments not shown',
    modelDistributionTitle: 'Model Distribution',
    modelDistributionDescription: 'Team-wide token share of the most used models.',
    ...
    clientSoftwareDescription: 'Team-wide client software products, normalized from request user agents.',
    ...
    unusedDepartmentsHint: 'Active, non-exclusive groups with no requests in the selected range.',
